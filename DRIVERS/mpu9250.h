...
typedef struct
{
	...
	port_pin_t int_pin; //A configurable interrupt output pin on this sensor.
	port_pin_t fsync;	//Frame synchronization pin
}mpu9250_t;
...
//DO NOT CALL
void mpu9250_twi_write_reg(mpu9250_t chip, uint8_t regi, uint8_t val);
void mpu9250_twi_read_multi(mpu9250_t chip, uint8_t regi, uint8_t length);
