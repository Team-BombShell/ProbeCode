...
#define GPS_USART							USARTD1
#define GPS_RECEIVE_INTERRUPT_VECTOR		USARTD1_RXC_vect
#define GPS_SEND_INTERRUPT_VECTOR			USARTD1_TXC_vect
#define GPS_SEND_PIN						IOPORT_CREATE_PIN(PORTD, 7)
#define GPS_RECIEVE_PIN						IOPORT_CREATE_PIN(PORTD, 6)
